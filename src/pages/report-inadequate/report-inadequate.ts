...
@IonicPage()
@Component({
  selector: 'page-report-inadequate',
  templateUrl: 'report-inadequate.html',
})
export class ReportInadequatePage {
    ...
    this.formValid(this.sendReportForm)
      .then(() => {
        ...
        this.restApi.sendReport(
          this.tour,
          AppConstants.REPORT_INADEQUATE,
